...
!
        ...
        IF (mod(dtBgc*Iter,5.0d0*86400.0d0).eq.0.0d0) THEN
          ...
          WRITE(*,'(i7,9a8)') int(cff),'daysDOMf','DOMs','MnO2','FeOOH','SO4',  &
     &                          'Mn','Fe','NH4','PO4'
...
!
     ...
     &      'DO','NH4','NO3','PO4','SO4','H2S','Mn','Fe','CH4','DOMf','DOMs', &
...
!
     ...
     &      'DO','NH4','NO3','PO4','SO4','H2S','Mn','Fe','DOMf','DOMs', &
     &      'POMf','POMs','POMn','FeOOHA','FeOOHB','FeOOHP',            &
     &      'MnO2A','MnO2B','S0','FeS','FeS2'
        END IF
!
     ...
     &                    pwflux(i,0,iwDOMf)*cff,                        &
     &                    pwflux(i,0,iwDOMs)*cff,                        &
     &                    (smflux(i,0,itrc)*cff,itrc=1,NBGCSM)
        END IF

1020    FORMAT (2(a,','), 6(a,'(mg/m2/day),'), 15(a,'(mmol/m2/day),'))
1021    FORMAT (23(f16.8,','))


!------------------------------------------------------------------------------
!  circulations output to csv
!------------------------------------------------------------------------------
!
        IF (Iter.eq.0) THEN
...
1030    FORMAT (2(a,','), 50('F',i02,'(mmol/m2/day),'))
